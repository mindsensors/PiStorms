          ...
          <div class="box box-danger">
            ...
            <div class="box-footer no-padding">
              <ul class="nav nav-stacked">
                ...
                <li><a>Software Version: <b><span class="software_version"><i class="fa fa-refresh fa-spin"></i>&nbsp;&nbsp;Fetching</span></b> <?php echo $updates == "both" || $updates == "software" ? $needsupdate : $uptodate; ?></a></li>
