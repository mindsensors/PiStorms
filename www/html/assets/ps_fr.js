...
//PiStorm
Blockly.Msg.SET_SPEED_OF_MOTOR = "mettre la vitesse du moteur";
Blockly.Msg.TO = "à";
Blockly.Msg.GET_POSITION_OF = "lire la postion de";
Blockly.Msg.RESET_POSITION_OF = "reinitialiser la position de";
Blockly.Msg.SET_MOTOR = "mettre le moteur";
Blockly.Msg.TO_BRAKE = "à l'arret";
Blockly.Msg.TO_FLOAT = "en roue libre";
Blockly.Msg.TO_HOLD = "à maintenir la position";
Blockly.Msg.SYNC_SPEED_OF_BANK = "synchroniser la vitesse de la \"bank\"";
Blockly.Msg.MOTORS_TO = "moteurs à";
Blockly.Msg.FLOAT_BANK = "en roue libre la \"bank\"";
Blockly.Msg.MOTORS = "moteurs";
Blockly.Msg.BRAKE_BANK = "arréter la \"bank\"";
Blockly.Msg.RUN_MOTOR = "tourner le moteur";
Blockly.Msg.FOR = "pour";
Blockly.Msg.AND = "et";
Blockly.Msg.WHEN_DONE = "quand fini";
Blockly.Msg.CHECK_IF_MOTOR = "vérifier si le moteur";
Blockly.Msg.IS_BUSY = "est occupé";
Blockly.Msg.IS_STALLED = "est bloqué";
Blockly.Msg.IS_OVERLOADED = "est surchargé";
Blockly.Msg.WAIT_UNTIL_MOTOR = "attendre jusqu'a ce que le moteur";
Blockly.Msg.STOPS = "arrétés";
Blockly.Msg.SET_PERFORMANCE_PARAMETERS_FOR_BANK = "definir les paramétres de performance de la \"bank\"";
Blockly.Msg.DEGREES_AT_SPEED = "degrées à la vitesse";
Blockly.Msg.SECONDS_AT_SPEED = "secondes à la vitesse";
Blockly.Msg.BRAKE = "arret";
Blockly.Msg.DON_T_BRAKE = "pas arréter";
Blockly.Msg.HOLD = "maintenir";
Blockly.Msg.PRINT = "afficher";
Blockly.Msg.PAUSE_FOR = "attendre pour";
Blockly.Msg.GET_BATTERY_VOLTAGE = "lire la tension de la batterie";
